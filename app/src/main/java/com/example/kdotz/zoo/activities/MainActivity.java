...
import com.example.kdotz.zoo.fragments.ExhibitsListFragment;
import com.example.kdotz.zoo.fragments.GalleryFragment;
import com.example.kdotz.zoo.fragments.ZooMapFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActionBarDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.drawer_opened, R.string.drawer_opened){
            @Override
